...
<head>
  ...
  <style>
    /* ... cały poprzedni CSS ... */
    /* tylko tu zostawiam styling filtrów */
...
<body>
  ...
  <div class="tabs">
    <button type="button" class="tab-button active" data-tab="table">Tabela</button>
    <button type="button" class="tab-button" data-tab="map">Mapa</button>
    <button type="button" class="tab-button" data-tab="charts">Wykresy i statystyki</button>
  </div>
